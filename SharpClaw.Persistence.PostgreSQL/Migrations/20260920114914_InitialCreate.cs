        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordKey = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    StringValue = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScopedStorageIndexes_SourceId_StorageName_IndexName_BoolVal~",
                table: "ScopedStorageIndexes",
                columns: new[] { "SourceId", "StorageName", "IndexName", "BoolValue", "RecordKey" });

            migrationBuilder.CreateIndex(
                name: "IX_ScopedStorageIndexes_SourceId_StorageName_IndexName_DateTim~",
                table: "ScopedStorageIndexes",
                columns: new[] { "SourceId", "StorageName", "IndexName", "DateTimeValue", "RecordKey" });

            migrationBuilder.CreateIndex(
                name: "IX_ScopedStorageIndexes_SourceId_StorageName_IndexName_NumberV~",
                table: "ScopedStorageIndexes",
                columns: new[] { "SourceId", "StorageName", "IndexName", "NumberValue", "RecordKey" });

            migrationBuilder.CreateIndex(
                name: "IX_ScopedStorageIndexes_SourceId_StorageName_IndexName_StringV~",
                table: "ScopedStorageIndexes",
